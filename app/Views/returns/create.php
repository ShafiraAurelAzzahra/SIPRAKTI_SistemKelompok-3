        ...
        <div class="col-12 col-md-6 mb-3">
          <div class="row">
            <div class="col-12 mb-3">
              ...
              <input type="text" class="form-control" id="item_title" name="item_title" value="<?= "{$loan['title']} ({$loan['year']})"; ?>" disabled>
            </div>
            <div class="col-12 mb-3">
              <label for="item_author" class="form-label">merk & produsen</label>
              <input type="text" class="form-control" id="item_author" name="item_author" value="<?= "{$loan['author']}; {$loan['publisher']}"; ?>" disabled>
            </div>
            <div class="col-12 mb-3">
              <label for="item_category" class="form-label">Kategori</label>
              <input type="text" class="form-control" id="item_category" name="item_category" value="<?= $loan['category']; ?>" disabled>
            </div>
            <div class="col-12 mb-3">
        ...
        ?>
          ...
          <div class="row">
            <div class="col-12 col-md-8 mb-4 mb-md-2">
              <p>Keterlambatan * Jumlah barang * Denda per hari per barang</p>
              <div class="row">
                ...
                <div class="col-4 d-flex">
                  <div>
                    <input type="number" class="form-control" value="<?= $loan['quantity']; ?>" aria-describedby="itemQuantity" disabled>
                    <div id="itemQuantity" class="form-text">
                      Jumlah barang
                    </div>
                  </div>
                  <h3 class="ps-4">*</h3>
