...
<a href="<?= base_url('admin/items'); ?>" class="btn btn-outline-primary mb-3">
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title fw-semibold">Form Tambah Barang</h5>
        ...
        <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3 p-3">
          <label for="cover" class="d-block" style="cursor: pointer;">
            <div class="d-flex justify-content-center bg-light overflow-hidden h-100 position-relative">
              <img id="itemCoverPreview" src="<?= base_url(ITEM_COVER_URI . DEFAULT_ITEM_COVER); ?>" alt="" height="300" class="z-1">
              <p class="position-absolute top-50 start-50 translate-middle z-0">Pilih gambar barang</p>
            </div>
          </label>
        </div>
