...
/**
 * item cover path
 * `public/uploads/item_cover/`
 */
defined('ITEM_COVER_PATH') || define('ITEM_COVER_PATH', UPLOADS_PATH . 'item_cover' . DIRECTORY_SEPARATOR);
 ...
 * `uploads/item_cover/`
 */
defined('ITEM_COVER_URI') || define('ITEM_COVER_URI', 'uploads' . DIRECTORY_SEPARATOR . 'item_cover' . DIRECTORY_SEPARATOR);

/**
 * Default item cover filename
 * `default.jpg`
 */
defined('DEFAULT_ITEM_COVER') || define('DEFAULT_ITEM_COVER', 'default.jpg');
